...
Object.assign(entries,{
  ...
  'Uploading…':['Enviando…','Subiendo…','正在上传…'],'Media uploaded.':['Mídia enviada.','Medio subido.','媒体已上传。'],'Files stored in the private Livefy media bucket.':['Arquivos armazenados no bucket privado de mídia da Livefy.','Archivos almacenados en el bucket privado de medios de Livefy.','文件存储在 Livefy 私有媒体存储桶中。'],
